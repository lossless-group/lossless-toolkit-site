---
title: "An open source, unified model and set of language-specific SDKs for defining and executing data processing workflows"
slug: "an-open-source-unified-model-and-set-of-language-specific-sdks-for-defin"
description: "Apache Beam is an open source, unified model and set of language-specific SDKs for defining and executing data processing workflows, and also data ingestion and integration flows, supporting Enterprise Integration Patterns (EIPs) and Domain Specific Languages (DSLs). Dataflow pipelines simplify the mechanics of large-scale batch and streaming data processing and can run on a number of runtimes lik"
url: "https://beam.apache.org"
og_image: "https://i.imgur.com/NsinEpz.png"
favicon: "https://beam.apache.org/images/favicon.ico"
